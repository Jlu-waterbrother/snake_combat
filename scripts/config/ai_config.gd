...
@export var turn_responsiveness: float = 5.4
@export var hazard_probe_interval: float = 0.08
@export var hazard_probe_distance: float = 220.0
@export var hazard_probe_angle_deg: float = 36.0
@export var head_on_avoid_distance: float = 260.0
@export var caution_length_ratio: float = 1.15
